...
from hivemind_etl_helpers.src.db.github.fetch_raw_data import fetch_issues
...
class TestGithubETLFetchIssues(TestCase):
    ...
    def test_get_multiple_issues_single_repo(self):
        ...
        self.assertEqual(issues[1].created_at, "2024-02-09T10:23:50Z")
        self.assertEqual(issues[1].updated_at, "2024-02-09T12:56:05Z")
        self.assertEqual(issues[1].latest_saved_at, "2024-02-15T06:10:02.262000000Z")
    ...
    def test_get_multiple_issues_single_repo_with_filtering(self):
        ...
        self.assertEqual(issues[0].state, "closed")
        self.assertEqual(issues[0].state_reason, "completed")
        self.assertEqual(issues[0].created_at, "2024-02-09T10:23:50Z")
        self.assertEqual(issues[0].updated_at, "2024-02-09T12:56:05Z")
        self.assertEqual(issues[0].latest_saved_at, "2024-02-15T06:10:02.262000000Z")
