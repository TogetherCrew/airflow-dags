...
class NotionProcessor:
    ...
    def process_page(self, page_id: str) -> None:
        ...
        page_id : str
            the notion page id
        """
        logging.info(f"Processing page_id: {page_id}, of community id: {self.community_id}")
    ...
    def process_database(self, database_id: str) -> None:
        ...
        """
        logging.info(f"Processing database id: {database_id}, of community id: {self.community_id}")
