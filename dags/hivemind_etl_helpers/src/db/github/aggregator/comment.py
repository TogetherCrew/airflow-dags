...
class CommentAggregator:
    def __init__(self):
        self.daily_comments: dict[str, list[dict]] = defaultdict(list)
    ...
    def add_comment(self, comment: GitHubComment) -> None:
        ...
        self.daily_comments[date_str].append(comment_dict)
