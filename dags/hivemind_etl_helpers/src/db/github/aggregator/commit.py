...
class CommitAggregator:
    def __init__(self):
        self.daily_commits: dict[str, list[dict]] = defaultdict(list)
    ...
    def add_commit(self, commit: GitHubCommit) -> None:
        ...
        self.daily_commits[date_str].append(commit_dict)
