...
class TestDateTimeFormatConverter(unittest.TestCase):
    ...
    def test_to_iso_format(self):
        dt = datetime(2023, 7, 1, 16, 57, 46, 149000)
    ...
    def test_from_iso_format(self):
        ...
        expected_dt = datetime(2023, 7, 1, 16, 57, 46, 149000, tzinfo=timezone.utc)
    ...
    def test_from_date_string(self):
        ...
        self.assertEqual(dt, datetime(2023, 7, 1, 0, 0, 0, 0))
        
        dt_with_time = DateTimeFormatConverter.from_date_string(date_string, 18, 21, 0, 870000)
        self.assertEqual(dt_with_time, datetime(2023, 7, 1, 18, 21, 0, 870000))
