...
class TestUserBotChecker(unittest.TestCase):
            ...
            [
                {
                    "_id": ObjectId(),
                    "type": 0,
                    "author": "000000000000000001",
                    "content": "sample message",
                    "user_mentions": ["000000000000000002", "000000000000000003"],
                    "role_mentions": ["000000000000000004", "000000000000000005"],
                    "reactions": ["000000000000000006,thelounge",
                                "000000000000000007,000000000000000008,👌"],
                    "replied_user": None,
                    "createdDate": datetime(2023, 6, 30, 20, 28, 3, 494000),
                    "messageId": "000000000000000009",
                ...
                },
                {
                    "_id": ObjectId(),
                    "type": 0,
                    "author": "000000000000000011",
                    "content": "another sample message",
                    "user_mentions": ["000000000000000012"],
                    "role_mentions": [],
                    "reactions": [],
                    "replied_user": "000000000000000001",
                    "createdDate": datetime(2023, 6, 30, 20, 28, 3, 494000),
                    "messageId": "000000000000000013",
                    "channelId": "000000000000000014",
    ...
    def test_is_user_bot(self):
        ...
        self.assertFalse(checker.is_user_bot("000000000000000001"))

        self.assertTrue(checker.is_user_bot("000000000000000011"))

        self.assertFalse(checker.is_user_bot("000000000000000012"))
